...
mon =>  MVP
tues => Quick Retro and pivot, V1 feature implementations ...and V2 if possible
wed => V1 ..V2 Implmentation , Reasses Features at 4pm wed.
thurs => want majority of front end last minute overhauling happening today if you want. If feature is giving you a fire and it's not MVP cut it. 8pm work on video .

TRELLO BOARD: https://trello.com/b/YeJHUPAG/remed4me
...
**get this to a basic working CSS build so that you'd only need the 24hour buffer to clean it up

Deployed:
https://intense-brook-1736.herokuapp.com/
https://git.heroku.com/intense-brook-1736.git
Note: paperclip picture upload works but i guess issue is that heroku will wipe it at some point
